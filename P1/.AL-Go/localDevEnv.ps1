...
$GitHubHelperUrl = 'https://raw.githubusercontent.com/businesscentralapps/tmp25dIle-Actions/main/Github-Helper.psm1'
...
$ALGoHelperUrl = 'https://raw.githubusercontent.com/businesscentralapps/tmp25dIle-Actions/main/AL-Go-Helper.ps1'
